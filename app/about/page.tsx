        ...
        <main className="py-20 lg:py-32">
            <div className="container-page">
                ...
                <div className="mt-32 grid md:grid-cols-2 gap-10">
                    <div className="relative overflow-hidden rounded-3xl bg-primary-deep text-white p-10 md:p-14 border border-primary/20">
                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-card border border-border p-10 md:p-14 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="mt-32">
                    ...
                    <div className="mt-16 grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                        {facultyDetails.map((faculty) => (
                            <div key={faculty.name} className="group rounded-3xl border border-border bg-card overflow-hidden transition-all hover:shadow-2xl hover:-translate-y-1 hover:border-primary/20">
